...
namespace Prometheus.Migrations
{
    ...
    [Migration("20230418175610_CreateMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prometheus.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 4, 18, 17, 56, 9, 839, DateTimeKind.Utc).AddTicks(7950),
                            Deleted = false,
                            Slug = "administrator",
                            UpdatedAt = new DateTime(2023, 4, 18, 17, 56, 9, 839, DateTimeKind.Utc).AddTicks(7950)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 4, 18, 17, 56, 9, 839, DateTimeKind.Utc).AddTicks(7960),
                            Deleted = false,
                            Slug = "teacher",
                            UpdatedAt = new DateTime(2023, 4, 18, 17, 56, 9, 839, DateTimeKind.Utc).AddTicks(7960)
                        },
                        new
                        {
                            Id = 3,
            ...
            modelBuilder.Entity("Prometheus.Data.Entities.Tournament", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Prometheus.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1a11db7e-9387-42a6-a8cb-0ffefc9494a2"),
                            CreatedAt = new DateTime(2023, 4, 18, 17, 56, 9, 839, DateTimeKind.Utc).AddTicks(8080),
                            Deleted = false,
                            Email = "admin@saei.com",
                            LastName = "Administrator",
                            Name = "Administrator",
                            Password = "$2a$13$z64t2g9RfHuR1vTJQDtpY.C4o9/awKkkMASu5Y3YyUF.nomQTDPga",
                            Phone = "1234567890",
                            RoleId = 1,
                            UpdatedAt = new DateTime(2023, 4, 18, 17, 56, 9, 839, DateTimeKind.Utc).AddTicks(8080)
                        });
                });
            ...
            modelBuilder.Entity("Prometheus.Data.Entities.Match", b =>
                {
                    ...
                    b.HasOne("Prometheus.Data.Entities.Tournament", "Tournament")
                        .WithMany("Matches")
                        .HasForeignKey("TournamentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Prometheus.Data.Entities.Team", "WinningTeam")
                        .WithOne()
                        .HasForeignKey("Prometheus.Data.Entities.Match", "WinningTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
